...
function _load_fs() {return _fs = _interopRequireDefault(require('fs'));}var _jestUtil;
function _load_jestUtil() {return _jestUtil = require('jest-util');}var _jestJasmine;
...
function _load_jestJasmine() {return _jestJasmine = _interopRequireDefault(require('jest-jasmine2'));}var _jestConfig;
function _load_jestConfig() {return _jestConfig = require('jest-config');}var _jestDocblock;
function _load_jestDocblock() {return _jestDocblock = _interopRequireDefault(require('jest-docblock'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
(_jestJasmine || _load_jestJasmine()).default; /**
                                                ...
                                                *
                                                * 
                                                */function runTest(path, globalConfig, config, resolver) {let testSource;

  try {
    testSource = (_fs || _load_fs()).default.readFileSync(path, 'utf8');
  } catch (e) {
