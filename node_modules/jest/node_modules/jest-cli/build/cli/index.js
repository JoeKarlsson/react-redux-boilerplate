'use strict';let run = (() => {var _ref = _asyncToGenerator(
  ...
  function* (maybeArgv, project) {
    ...
    _readResultsAndExit(results, globalConfig);
  });return function run(_x, _x2) {return _ref.apply(this, arguments);};})();var _jestUtil;function _load_jestUtil() {return _jestUtil = require('jest-util');}var _jestConfig;function _load_jestConfig() {return _jestConfig = require('jest-config');}var _package;function _load_package() {return _package = require('../../package.json');}var _args;function _load_args() {return _args = _interopRequireDefault(require('./args'));}var _chalk;function _load_chalk() {return _chalk = _interopRequireDefault(require('chalk'));}var _create_context;function _load_create_context() {return _create_context = _interopRequireDefault(require('../lib/create_context'));}var _get_changed_files_promise;function _load_get_changed_files_promise() {return _get_changed_files_promise = _interopRequireDefault(require('../get_changed_files_promise'));}var _get_jest;function _load_get_jest() {return _get_jest = _interopRequireDefault(require('./get_jest'));}var _handle_deprecation_warnings;function _load_handle_deprecation_warnings() {return _handle_deprecation_warnings = _interopRequireDefault(require('../lib/handle_deprecation_warnings'));}var _log_debug_messages;function _load_log_debug_messages() {return _log_debug_messages = _interopRequireDefault(require('../lib/log_debug_messages'));}var _pre_run_message;function _load_pre_run_message() {return _pre_run_message = _interopRequireDefault(require('../pre_run_message'));}var _run_jest;function _load_run_jest() {return _run_jest = _interopRequireDefault(require('../run_jest'));}var _jestRuntime;function _load_jestRuntime() {return _jestRuntime = _interopRequireDefault(require('jest-runtime'));}var _test_watcher;function _load_test_watcher() {return _test_watcher = _interopRequireDefault(require('../test_watcher'));}var _watch;function _load_watch() {return _watch = _interopRequireDefault(require('../watch'));}var _yargs;function _load_yargs() {return _yargs = _interopRequireDefault(require('yargs'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _asyncToGenerator(fn) {return function () {var gen = fn.apply(this, arguments);return new Promise(function (resolve, reject) {function step(key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {return Promise.resolve(value).then(function (value) {step("next", value);}, function (err) {step("throw", err);});}}return step("next");});};} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   *
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   */const runCLI = (() => {var _ref3 = _asyncToGenerator(function* (argv, projects) {let results; // Optimize 'fs' module and make it more compatible with multiple platforms.
...
const _buildArgv = (maybeArgv, project) => {
  ...
  usage((_args || _load_args()).default.usage).
  alias('help', 'h').
  options((_args || _load_args()).default.options).
  epilogue((_args || _load_args()).default.docs).
  check((_args || _load_args()).default.check).
  version(false).argv;

  (0, (_jestUtil || _load_jestUtil()).validateCLIOptions)(argv, (_args || _load_args()).default.options);
