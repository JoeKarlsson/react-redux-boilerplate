...
const check = argv => {
  ...
  return true;
    ...
    *
    * 
    */const usage = 'Usage: $0 [--config=<pathToConfigFile>] [TestPathPattern]';const docs = 'Documentation: https://facebook.github.io/jest/';const options = { all: { default: undefined, description:
