...
class ReporterDispatcher {
  ...
  onTestStart(test) {var _this2 = this;return _asyncToGenerator(function* () {
      for (const reporter of _this2._reporters) {
        reporter.onTestStart && (yield reporter.onTestStart(test));
      }})();
  }

  onRunStart(results, options) {var _this3 = this;return _asyncToGenerator(function* () {
      for (const reporter of _this3._reporters) {
        reporter.onRunStart && (yield reporter.onRunStart(results, options));
      }})();
  }

  onRunComplete(contexts, results) {var _this4 = this;return _asyncToGenerator(function* () {
