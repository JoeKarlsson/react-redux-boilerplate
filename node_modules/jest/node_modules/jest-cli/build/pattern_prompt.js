...
function _load_ansiEscapes() {return _ansiEscapes = _interopRequireDefault(require('ansi-escapes'));}var _Prompt;
...
`${(_chalk || _load_chalk()).default.dim(`to apply pattern to all ${entity}.`)}\n` +
`\n`;
