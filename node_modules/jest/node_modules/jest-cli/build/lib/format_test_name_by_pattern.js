...
function _load_chalk() {return _chalk = _interopRequireDefault(require('chalk'));}var _colorize;
...
function _load_colorize() {return _colorize = _interopRequireDefault(require('./colorize'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                            ...
                                                                                                                                                                                            *
                                                                                                                                                                                            * 
                                                                                                                                                                                            */const DOTS = '...';const ENTER = '⏎';module.exports = (testName, pattern, width) => {const inlineTestName = testName.replace(/(\r\n|\n|\r)/gm, ENTER);let regexp;
  ...
  if (startPatternIndex < slicedTestName.length) {
    if (endPatternIndex > slicedTestName.length) {
      return (0, (_colorize || _load_colorize()).default)(
      slicedTestName + DOTS,
      startPatternIndex,
