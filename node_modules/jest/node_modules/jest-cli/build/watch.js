...
function _load_ansiEscapes() {return _ansiEscapes = _interopRequireDefault(require('ansi-escapes'));}var _chalk;
function _load_chalk() {return _chalk = _interopRequireDefault(require('chalk'));}var _get_changed_files_promise;
function _load_get_changed_files_promise() {return _get_changed_files_promise = _interopRequireDefault(require('./get_changed_files_promise'));}var _jestRegexUtil;
function _load_jestRegexUtil() {return _jestRegexUtil = require('jest-regex-util');}var _jestHasteMap;
function _load_jestHasteMap() {return _jestHasteMap = _interopRequireDefault(require('jest-haste-map'));}var _isCi;
function _load_isCi() {return _isCi = _interopRequireDefault(require('is-ci'));}var _is_valid_path;
function _load_is_valid_path() {return _is_valid_path = _interopRequireDefault(require('./lib/is_valid_path'));}var _pre_run_message;
function _load_pre_run_message() {return _pre_run_message = _interopRequireDefault(require('./pre_run_message'));}var _create_context;
function _load_create_context() {return _create_context = _interopRequireDefault(require('./lib/create_context'));}var _run_jest;
function _load_run_jest() {return _run_jest = _interopRequireDefault(require('./run_jest'));}var _update_global_config;
function _load_update_global_config() {return _update_global_config = _interopRequireDefault(require('./lib/update_global_config'));}var _search_source;
function _load_search_source() {return _search_source = _interopRequireDefault(require('./search_source'));}var _test_watcher;
function _load_test_watcher() {return _test_watcher = _interopRequireDefault(require('./test_watcher'));}var _Prompt;
function _load_Prompt() {return _Prompt = _interopRequireDefault(require('./lib/Prompt'));}var _test_path_pattern_prompt;
function _load_test_path_pattern_prompt() {return _test_path_pattern_prompt = _interopRequireDefault(require('./test_path_pattern_prompt'));}var _test_name_pattern_prompt;
function _load_test_name_pattern_prompt() {return _test_name_pattern_prompt = _interopRequireDefault(require('./test_name_pattern_prompt'));}var _constants;
...
const isInteractive = process.stdout.isTTY && !(_isCi || _load_isCi()).default; /**
                                                                                 ...
                                                                                 *
                                                                                 * 
                                                                                 */let hasExitListener = false;const watch = function (initialGlobalConfig, contexts, outputStream, hasteMapInstances)
{let stdin = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : process.stdin;
  ...
  const startRun = globalConfig => {
    ...
    (_pre_run_message || _load_pre_run_message()).default.print(outputStream);
    isRunning = true;
