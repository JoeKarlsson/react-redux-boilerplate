...
function _load_chalk() {return _chalk = _interopRequireDefault(require('chalk'));}var _slash;
function _load_slash() {return _slash = _interopRequireDefault(require('slash'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
const printDisplayName = config => {const
  displayName = config.displayName;

  if (displayName) {
    return (_chalk || _load_chalk()).default.supportsColor ?
    (_chalk || _load_chalk()).default.reset.inverse.white(` ${displayName} `) :
    displayName;
  }
...
columns) =>
{
  ...
  return (0, (_slash || _load_slash()).default)(
...
options) =>
{
  ...
  const suites =
  (_chalk || _load_chalk()).default.bold('Test Suites: ') + (
  suitesFailed ? (_chalk || _load_chalk()).default.bold.red(`${suitesFailed} failed`) + ', ' : '') + (
  suitesPending ?
  (_chalk || _load_chalk()).default.bold.yellow(`${suitesPending} skipped`) + ', ' :
  '') + (
  suitesPassed ? (_chalk || _load_chalk()).default.bold.green(`${suitesPassed} passed`) + ', ' : '') + (
  ...
  const tests =
  (_chalk || _load_chalk()).default.bold('Tests:       ') + (
  testsFailed ? (_chalk || _load_chalk()).default.bold.red(`${testsFailed} failed`) + ', ' : '') + (
  testsPending ? (_chalk || _load_chalk()).default.bold.yellow(`${testsPending} skipped`) + ', ' : '') + (
  testsPassed ? (_chalk || _load_chalk()).default.bold.green(`${testsPassed} passed`) + ', ' : '') +
  `${testsTotal} total`;

  const snapshots =
  (_chalk || _load_chalk()).default.bold('Snapshots:   ') + (
  snapshotsFailed ?
  (_chalk || _load_chalk()).default.bold.red(`${snapshotsFailed} failed`) + ', ' :
  '') + (
  snapshotsUpdated ?
  (_chalk || _load_chalk()).default.bold.green(`${snapshotsUpdated} updated`) + ', ' :
  '') + (
  snapshotsAdded ? (_chalk || _load_chalk()).default.bold.green(`${snapshotsAdded} added`) + ', ' : '') + (
  snapshotsPassed ?
  (_chalk || _load_chalk()).default.bold.green(`${snapshotsPassed} passed`) + ', ' :
  '') +
...
const renderTime = (runTime, estimatedTime, width) => {
  ...
  (_chalk || _load_chalk()).default.bold.yellow(runTime + 's') :
  runTime + 's';
  ...
  if (estimatedTime > 2 && runTime < estimatedTime && width) {
    ...
    if (availableWidth >= 2) {
      time +=
      '\n' +
      (_chalk || _load_chalk()).default.green('█').repeat(length) +
      (_chalk || _load_chalk()).default.white('█').repeat(availableWidth - length);
    }
  }
  return time;
};
