...
function _load_isCi() {return _isCi = _interopRequireDefault(require('is-ci'));}var _base_reporter;
function _load_base_reporter() {return _base_reporter = _interopRequireDefault(require('./base_reporter'));}var _Status;
function _load_Status() {return _Status = _interopRequireDefault(require('./Status'));}var _get_result_header;
function _load_get_result_header() {return _get_result_header = _interopRequireDefault(require('./get_result_header'));}var _get_snapshot_status;
function _load_get_snapshot_status() {return _get_snapshot_status = _interopRequireDefault(require('./get_snapshot_status'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
const TITLE_BULLET = (_chalk || _load_chalk()).default.bold('\u25cf '); /**
                                                                         ...
                                                                         *
                                                                         * 
                                                                         */ /* global stream$Writable, tty$WriteStream */const isInteractive = process.stdin.isTTY && !(_isCi || _load_isCi()).default;class DefaultReporter extends (_base_reporter || _load_base_reporter()).default {
