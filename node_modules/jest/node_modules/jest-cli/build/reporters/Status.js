...
function _load_stringLength() {return _stringLength = _interopRequireDefault(require('string-length'));}var _utils;
function _load_utils() {return _utils = require('./utils');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                           ...
                                                                                                                                                           *
                                                                                                                                                           * 
                                                                                                                                                           */const RUNNING_TEXT = ' RUNS ';const RUNNING = (_chalk || _load_chalk()).default.reset.inverse.yellow.bold(RUNNING_TEXT) + ' ';
  ...
  get() {
    ...
    this._currentTests.get().forEach(record => {
      if (record) {const
        ...
        prefix +
        (0, (_utils || _load_utils()).trimAndFormatPath)((0, (_stringLength || _load_stringLength()).default)(prefix), config, testPath, width),
        width) +
        '\n';
      }
    });
