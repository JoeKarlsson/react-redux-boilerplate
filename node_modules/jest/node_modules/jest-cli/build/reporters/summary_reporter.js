...
function _load_chalk() {return _chalk = _interopRequireDefault(require('chalk'));}var _base_reporter;
function _load_base_reporter() {return _base_reporter = _interopRequireDefault(require('./base_reporter'));}var _utils;
function _load_utils() {return _utils = require('./utils');}var _get_result_header;
function _load_get_result_header() {return _get_result_header = _interopRequireDefault(require('./get_result_header'));}var _get_snapshot_summary;
function _load_get_snapshot_summary() {return _get_snapshot_summary = _interopRequireDefault(require('./get_snapshot_summary'));}var _test_path_pattern_to_regexp;
function _load_test_path_pattern_to_regexp() {return _test_path_pattern_to_regexp = _interopRequireDefault(require('../test_path_pattern_to_regexp'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                      *
                                                                                                                                                                                                                                                      * 
                                                                                                                                                                                                                                                      */const TEST_SUMMARY_THRESHOLD = 20;const NPM_EVENTS = new Set(['prepublish', 'publish', 'postpublish', 'preinstall',
'install',
'postinstall',
'preuninstall',
'uninstall',
...
class SummaryReporter extends (_base_reporter || _load_base_reporter()).default {
    ...
    if (numTotalTestSuites) {
      ...
      if (numTotalTestSuites) {
        ...
        if (!this._globalConfig.silent) {
          ...
          '\n' + (
          wasInterrupted ?
          (_chalk || _load_chalk()).default.bold.red('Test run was interrupted.') :
  ...
  globalConfig)
  {
    ...
    aggregatedResults.numTotalTestSuites > TEST_SUMMARY_THRESHOLD)
    {
      ...
      aggregatedResults.testResults.forEach(testResult => {const
        ...
        if (failureMessage) {
          this._write(
          (0, (_get_result_header || _load_get_result_header()).default)(testResult, globalConfig) +
          '\n' +
          failureMessage +
          '\n');
  ...
  _getTestSummary(contexts, globalConfig) {
    const getMatchingTestsInfo = () => {
      ...
      return (
        (_chalk || _load_chalk()).default.dim(prefix) +
        (0, (_test_path_pattern_to_regexp || _load_test_path_pattern_to_regexp()).default)(globalConfig.testPathPattern).toString());
    ...
    if (globalConfig.runTestsByPath) {
      ...
      nameInfo =
      (_chalk || _load_chalk()).default.dim(' with tests matching ') +
      `"${globalConfig.testNamePattern}"`;
    }

    const contextInfo =
    contexts.size > 1 ?
    (_chalk || _load_chalk()).default.dim(' in ') + contexts.size + (_chalk || _load_chalk()).default.dim(' projects') :
    '';

    return (
      (_chalk || _load_chalk()).default.dim('Ran all test suites') +
      testInfo +
      nameInfo +
      contextInfo +
