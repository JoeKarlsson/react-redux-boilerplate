...
function _load_sane() {return _sane = _interopRequireDefault(require('sane'));}var _workerFarm;
function _load_workerFarm() {return _workerFarm = _interopRequireDefault(require('worker-farm'));}var _package;
...
function _load_get_platform_extension() {return _get_platform_extension = _interopRequireDefault(require('./lib/get_platform_extension'));}var _node;
function _load_node() {return _node = _interopRequireDefault(require('./crawlers/node'));}var _normalize_path_sep;
function _load_normalize_path_sep() {return _normalize_path_sep = _interopRequireDefault(require('./lib/normalize_path_sep'));}var _watchman;
function _load_watchman() {return _watchman = _interopRequireDefault(require('./crawlers/watchman'));}var _worker;
 ...
 *
 * 
 */const MAX_WAIT_TIME = 240000;const NODE_MODULES = (_path || _load_path()).default.sep + 'node_modules' + (_path || _load_path()).default.sep;const canUseWatchman = (() => {try {(0, (_child_process || _load_child_process()).execSync)('watchman --version', { stdio: ['ignore'] });return true;} catch (e) {}return false;})();
...
class HasteMap extends (_events || _load_events()).default {
  ...
  _buildHasteMap(hasteMap) {
    ...
    const cleanup = () => {
      if (this._workerFarm) {
        (_workerFarm || _load_workerFarm()).default.end(this._workerFarm);
      }
      this._workerFarm = null;
      this._workerPromise = null;
    };
  ...
  options)
  {
    if (!this._workerPromise) {
      ...
      if (options && options.forceInBand || this._options.maxWorkers <= 1) {
        workerFn = (_worker || _load_worker()).default;
      } else {
        this._workerFarm = (0, (_workerFarm || _load_workerFarm()).default)(
        {
