...
function _load_node_modules_paths() {return _node_modules_paths = _interopRequireDefault(require('./node_modules_paths'));}var _isBuiltinModule;
function _load_isBuiltinModule() {return _isBuiltinModule = _interopRequireDefault(require('is-builtin-module'));}var _default_resolver;
 ...
 *
 * 
 */const cwd = process.cwd();const resolvedCwd = (_fs || _load_fs()).default.realpathSync(cwd) || cwd;const nodePaths = process.env.NODE_PATH ? process.env.NODE_PATH.split((_path || _load_path()).default.delimiter).filter(Boolean) // The resolver expects absolute paths.
...
class Resolver {
  ...
  isCoreModule(moduleName) {
    return this._options.hasCoreModules && (0, (_isBuiltinModule || _load_isBuiltinModule()).default)(moduleName);
  }
