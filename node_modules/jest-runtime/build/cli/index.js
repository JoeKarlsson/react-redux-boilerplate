...
function _load_chalk() {return _chalk = _interopRequireDefault(require('chalk'));}var _yargs;
function _load_yargs() {return _yargs = _interopRequireDefault(require('yargs'));}var _jestUtil;
function _load_jestUtil() {return _jestUtil = require('jest-util');}var _jestConfig;
function _load_jestConfig() {return _jestConfig = require('jest-config');}var _;
function _load_() {return _ = _interopRequireDefault(require('../'));}var _args;
function _load_args() {return _args = _interopRequireDefault(require('./args'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                               ...
                                                                                                                                                                               *
                                                                                                                                                                               * 
                                                                                                                                                                               */const VERSION = require('../../package.json').version;function run(cliArgv, cliInfo) {let argv;if (cliArgv) {argv = cliArgv;} else {
    argv = (_yargs || _load_yargs()).default.
    usage((_args || _load_args()).default.usage).
    help(false).
    version(false).
    options((_args || _load_args()).default.options).argv;
  ...
  then(hasteMap => {
    ...
    environment.global,
    'console',
    new (_jestUtil || _load_jestUtil()).Console(process.stdout, process.stderr));
