...
function _load_path() {return _path = _interopRequireDefault(require('path'));}var _jestHasteMap;
function _load_jestHasteMap() {return _jestHasteMap = _interopRequireDefault(require('jest-haste-map'));}var _jestResolve;
function _load_jestResolve() {return _jestResolve = _interopRequireDefault(require('jest-resolve'));}var _jestUtil;
function _load_jestUtil() {return _jestUtil = require('jest-util');}var _jestRegexUtil;
function _load_jestRegexUtil() {return _jestRegexUtil = require('jest-regex-util');}var _gracefulFs;
function _load_gracefulFs() {return _gracefulFs = _interopRequireDefault(require('graceful-fs'));}var _stripBom;
function _load_stripBom() {return _stripBom = _interopRequireDefault(require('strip-bom'));}var _script_transformer;
function _load_script_transformer() {return _script_transformer = _interopRequireDefault(require('./script_transformer'));}var _should_instrument;
function _load_should_instrument() {return _should_instrument = _interopRequireDefault(require('./should_instrument'));}var _cli;
function _load_cli() {return _cli = _interopRequireDefault(require('./cli'));}var _args;
function _load_args() {return _args = _interopRequireDefault(require('./cli/args'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
class Runtime {
  ...
  static runCLI(args, info) {
    return (_cli || _load_cli()).default.run(args, info);
  }

  static getCLIOptions() {
    return (_args || _load_args()).default.options;
  }
  ...
  getSourceMapInfo() {
    return Object.keys(this._sourceMapRegistry).reduce((result, sourcePath) => {
      if ((_gracefulFs || _load_gracefulFs()).default.existsSync(this._sourceMapRegistry[sourcePath])) {
