...
function _load_path() {return _path = _interopRequireDefault(require('path'));}var _fs;
function _load_fs() {return _fs = _interopRequireDefault(require('fs'));}var _constants;
function _load_constants() {return _constants = require('./constants');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                       ...
                                                                                                                                                                       *
                                                                                                                                                                       * 
                                                                                                                                                                       */const isFile = filePath => (_fs || _load_fs()).default.existsSync(filePath) && !(_fs || _load_fs()).default.lstatSync(filePath).isDirectory();module.exports = (pathToResolve, cwd) => {if (!(_path || _load_path()).default.isAbsolute(cwd)) {throw new Error(`"cwd" must be an absolute path. cwd: ${cwd}`);}
...
cwd) =>
{
  ...
  if (pathToResolve === (_path || _load_path()).default.sep) {
