...
function _load_prettyFormat() {return _prettyFormat = _interopRequireDefault(require('pretty-format'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                                                       ...
                                                                                                                                                                                                       *
                                                                                                                                                                                                       * 
                                                                                                                                                                                                       */const format = value => (0, (_prettyFormat || _load_prettyFormat()).default)(value, { min: true });const deprecatedOptions = { preprocessorIgnorePatterns: options => `  Option ${(_chalk || _load_chalk()).default.bold('"preprocessorIgnorePatterns"')
