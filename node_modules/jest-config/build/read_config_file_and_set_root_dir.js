...
function _load_fs() {return _fs = _interopRequireDefault(require('fs'));}var _jsonlint;
function _load_jsonlint() {return _jsonlint = _interopRequireDefault(require('./vendor/jsonlint'));}var _constants;
...
module.exports = configPath => {
  ...
  if (configObject.rootDir) {
    ...
    if (!(_path || _load_path()).default.isAbsolute(configObject.rootDir)) {
      ...
      configObject.rootDir = (_path || _load_path()).default.resolve(
      (_path || _load_path()).default.dirname(configPath),
